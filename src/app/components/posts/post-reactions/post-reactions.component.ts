...
export class PostReactionsComponent extends PostsActionsService{
  ...
  constructor(protected override route:ActivatedRoute, protected override getService: GetService, protected override postService: PostService, protected override router: Router){
